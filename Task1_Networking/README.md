...
| **Public Subnet 1** | `10.0.1.0/24` | 256 IPs. Sufficient for public facing components. |
| **Public Subnet 2** | `10.0.2.0/24` | 256 IPs. Distinct range for the second AZ. |
| **Private Subnet 1** | `10.0.3.0/24` | 256 IPs. For backend resources in AZ 1. |
